...
namespace Newtonsoft.Json4.Tests.Linq
{
  public class JObjectTests : TestFixtureBase
  {
    ...
    [Test]
    [ExpectedException(typeof(ArgumentException), ExpectedMessage = "Can not add property PropertyNameValue to Newtonsoft.Json4.Linq.JObject. Property with the same name already exists on object.")]
...
Parameter name: arrayIndex")]
  ...
  ""o"": ""<div class='s1'>\r\n    <div class='avatar'>                    \r\n        <a href='asdf'>asdf</a><br />\r\n        <strong>0</strong>\r\n    </div>\r\n    <div class='sl'>\r\n        <p>\r\n            444444444\r\n        </p>\r\n    </div>\r\n    <div class='clear'>\r\n    </div>                        \r\n</div>""
    ...
    [Test]
    [ExpectedException(typeof(ArgumentException), ExpectedMessage = "Can not add Newtonsoft.Json4.Linq.JValue to Newtonsoft.Json4.Linq.JObject.")]
    ...
    [Test]
    [ExpectedException(typeof(ArgumentException), ExpectedMessage = "Can not add property Test2 to Newtonsoft.Json4.Linq.JObject. Property with the same name already exists on object.")]
    ...
    [Test]
    [ExpectedException(typeof(ArgumentException), ExpectedMessage = "Can not add property Test3 to Newtonsoft.Json4.Linq.JObject. Property with the same name already exists on object.")]
    ...
    [Test]
    [ExpectedException(typeof(Exception), ExpectedMessage = "Could not determine new value to add to 'Newtonsoft.Json4.Linq.JObject'.")]
