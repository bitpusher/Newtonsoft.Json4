...
namespace Newtonsoft.Json4.Tests
{
  ...
  public class PerformanceTests : TestFixtureBase
  {
    ...
    public string SerializeJsonNet(object value)
    {
      ...
      Newtonsoft.Json4.JsonSerializer json = new Newtonsoft.Json4.JsonSerializer();

      json.NullValueHandling = NullValueHandling.Ignore;

      json.ObjectCreationHandling = Newtonsoft.Json4.ObjectCreationHandling.Replace;
      json.MissingMemberHandling = Newtonsoft.Json4.MissingMemberHandling.Ignore;
      json.ReferenceLoopHandling = ReferenceLoopHandling.Ignore;


      StringWriter sw = new StringWriter();
      Newtonsoft.Json4.JsonTextWriter writer = new JsonTextWriter(sw);
    ...
    public T DeserializeJsonNet<T>(string json)
    {
      ...
      JsonSerializer serializer = new JsonSerializer();
      serializer.ObjectCreationHandling = Newtonsoft.Json4.ObjectCreationHandling.Replace;
      serializer.MissingMemberHandling = Newtonsoft.Json4.MissingMemberHandling.Ignore;
